...
/***/ "./src/declarations/Palak_backend/Palak_backend.did.js":
/*!*************************************************************!*\
  !*** ./src/declarations/Palak_backend/Palak_backend.did.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/Palak_backend/index.js":
/*!*************************************************!*\
  !*** ./src/declarations/Palak_backend/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Palak_backend: () => (/* binding */ Palak_backend),
/* harmony export */   canisterId: () => (/* binding */ canisterId),
/* harmony export */   createActor: () => (/* binding */ createActor),
/* harmony export */   idlFactory: () => (/* reexport safe */ _Palak_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _Palak_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Palak_backend.did.js */ "./src/declarations/Palak_backend/Palak_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_Palak_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const Palak_backend = createActor(canisterId);
...
"use strict";
/*!*****************************************!*\
  !*** ./src/Palak_frontend/src/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_Palak_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/Palak_backend */ "./src/declarations/Palak_backend/index.js");
...
appointForm.addEventListener("submit", async (e) => {
  ...
  try {
    const getId = await _declarations_Palak_backend__WEBPACK_IMPORTED_MODULE_0__.Palak_backend.addTodo(obj.textarea);
...
window.addEventListener("DOMContentLoaded", async () => {
  try {
    const getAll = await _declarations_Palak_backend__WEBPACK_IMPORTED_MODULE_0__.Palak_backend.getAllTodo();
...
async function deleteTodo(userId) {
  try {
    ...
    await _declarations_Palak_backend__WEBPACK_IMPORTED_MODULE_0__.Palak_backend.deleteTodo(userId);
